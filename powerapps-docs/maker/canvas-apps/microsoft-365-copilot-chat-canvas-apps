...
Microsoft 365 Copilot chat makes it easier for users to work with canvas apps by offering AI-powered insights through natural language conversations. With this feature, users can quickly find information, navigate apps more easily, and get help to boost their productivity.
...
This article shows you how to enable and configure Microsoft 365 Copilot chat for your canvas apps, both at the environment level and for individual apps.

When enabled, users can open Microsoft 365 Copilot chat in their canvas app by selecting **Copilot** > **Chat** on the upper-right corner. 
...
To manage Microsoft 365 Copilot Chat for canvas apps, start by learning [how to manage Microsoft 365 Copilot Chat](/copilot/manage).
...
1. Select **On** and then select **Save** to enable Microsoft 365 Copilot chat for your canvas apps in the selected environment group or environment.

## Enable Microsoft 365 Copilot chat in a canvas app

Makers can enable or disable Microsoft 365 Copilot chat for a specific canvas app.

1. Sign in to [Power Apps](https://make.powerapps.com).
1. Open a canvas app for editing.
1. Select **Settings** in the command bar.
1. On the left, select **Upcoming**.
1. To enable Microsoft 365 Copilot chat, set **M365 Copilot in canvas apps** to **On**. To disable it, set the option to **Off**.

1. Select **Save** and then publish the app for the changes to take effect.

## Microsoft 365 Copilot chat vs. Copilot chat

 Microsoft 365 Copilot chat is gradually replacing [Copilot control](add-ai-copilot.md) and [Custom Copilot](add-custom-copilot.md).
...
- Microsoft 365 Copilot for canvas apps allows users to view Dataverse data by using read-only operations. This capability means that users can only view data that matches their queries and can't make any changes. To make changes, customization with an agent is required.
