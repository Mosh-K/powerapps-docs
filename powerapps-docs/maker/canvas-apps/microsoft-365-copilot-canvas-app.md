...
- Your tenant must be set to allow **Dataverse data available in Microsoft 365 Copilot**. For more information, see [What is Dataverse intelligence?](../data-platform/data-platform-intelligence.md#enable-microsoft-365-admin-center-copilot-dataverse-settings-preview)
- Dataverse Search must be set to **Default** or **On** for the environment. More information, see [Know what this means for generative AI experiences](/power-platform/admin/configure-relevance-search-organization#what-dataverse-search-means-for-generative-ai-enabled-experiences)
