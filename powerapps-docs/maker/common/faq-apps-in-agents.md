...
**English only** — Power Apps in agents currently supports English-language queries and responses only. If you interact in other languages, you might receive inaccurate or unexpected results.
