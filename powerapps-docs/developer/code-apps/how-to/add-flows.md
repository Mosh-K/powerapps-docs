...
──────────────────────────────────────────────────────────────────────────────
Approval Workflow       Started  2026-01-15    a1b2c3d4-e5f6-7890-abcd-ef1234567890
Send Notification       Started  2026-02-01    f7g8h9i0-j1k2-3456-mnop-qr7890123456

Total flows: 2

Note: Only solution-aware flows are listed. If you are missing a flow, see:
...
Copy the **Flow ID** (GUID) of the flow you want to add. This is the Power Automate resource ID (the BAP/Power Automate GUID) required by the next step.

## Step 2: Add a flow to your code app

Run the following command, replacing `<flow-id>` with the GUID from the previous step:
...
"<uuid>": {
  ...
  "workflowDetails": {
    ...
    "workflowName": "<bap-resource-guid>",
    "dependencies": {
